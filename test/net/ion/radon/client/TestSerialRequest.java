...
public class TestSerialRequest {
	...
	public void basicGet() throws Exception {
		...
		ISerialRequest request = ac.createSerialRequest("/test?name=bleujin");
	...
	public void basicHeader() throws Exception {
		...
		AradonClient ac = AradonClientFactory.create(at.getAradon());
		ISerialRequest request = ac.createSerialRequest("/test2");
	...
	public void entitySerialObject() throws Exception {
		...
		AradonClient ac = AradonClientFactory.create("http://127.0.0.1:9150");
		ISerialRequest request = ac.createSerialRequest("/test");
