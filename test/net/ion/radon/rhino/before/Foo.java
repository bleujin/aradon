...
public class Foo extends ScriptableObject {
	 ...
	 * 
	 * When Context.defineClass is called with this class, it will construct Foo.prototype using this constructor.
	 */
	public Foo() {
	}
	 ...
	 * 
	 * Takes an initial value for the counter property. Note that in the example Shell session above, we didn't supply a argument to the Foo constructor. This means that the Undefined value is used as the value of the argument, and when the argument is converted to an integer, Undefined becomes 0.
	 */
	 ...
	 * <p>
	 * If "setCounter" had been defined in this class, the runtime would call the setter when the property is assigned to.
	 */
	 ...
	 * 
	 * All variable arguments methods must have the same number and types of parameters, and must be static.
	 * <p>
	 * 
	 * @param cx
	 ...
	 * @return computes the string values and types of 'this' and of each of the supplied arguments and returns them in a string.
	 * 
