 ...
 * 
 * This isn't intended to be any sort of definitive attempt at a standard File object for JavaScript, but instead is an example of a more involved definition of a host object.
 * 
 ...
 * 
 * 
 * File errors or end-of-file signaled by thrown Java exceptions will be wrapped as JavaScript exceptions when called from JavaScript, and may be caught within JavaScript.
 * 
 * @author Norris Boyd
 */
public class File extends ScriptableObject {
	 ...
	 * 
	 * When Context.defineClass is called with this class, it will construct File.prototype using this constructor.
	 */
	public File() {
	}
	 ...
	 * 
	 * If the constructor has one or more arguments, and the first argument is not undefined, the argument is converted to a string as used as the filename.
	 * <p>
	 * 
	 ...
	 * <p>
	 * 
	 * This is a good example of creating a new array and setting elements in that array.
	 * 
	 * @exception IOException
	 *                if an error occurred while accessing the file associated with this object
	 */
	 ...
	 * 
	 * @exception IOException
	 *                if an error occurred while accessing the file associated with this object, or EOFException if the object reached the end of the file
	 */
	 ...
	 * <p>
	 * 
	 * This function takes a variable number of arguments, converts each argument to a string, and writes that string to the file.
	 * 
	 * @exception IOException
	 *                if an error occurred while accessing the file associated with this object
	 */
	...
	private LineNumberReader getReader() throws FileNotFoundException {
		...
		if (reader == null)
			reader = new LineNumberReader(file == null ? new InputStreamReader(System.in) : new FileReader(file));
		return reader;
	}
	 ...
	 * 
	 * Since the two functions differ only in whether they write a newline character, move the code into a common subroutine.
	 * 
	 */
	 ...
	 * 
	 * This is necessary since methods may reside in the File.prototype object and scripts can dynamically alter prototype chains. For example:
	 * 
	 * <pre>
	 * js> defineClass("File");
	 * js> o = {};
	 ...
	 * </pre>
	 * 
	 * The runtime will take care of such checks when non-static Java methods are defined as JavaScript functions.
	 */
