...
import net.ion.radon.core.server.jetty.HttpsServerHelper;
...
public class JettyHandler extends AbstractHandler {
	...
	public void handle(String target, Request arg1, HttpServletRequest servletRequest, HttpServletResponse servletResponse) throws IOException, ServletException {
		final Request baseRequest = (servletRequest instanceof Request) ? (Request) servletRequest : HttpConnection.getCurrentConnection().getRequest();
