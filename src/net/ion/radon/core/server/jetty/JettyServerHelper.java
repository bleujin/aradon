...
package net.ion.radon.core.server.jetty;
 ...
 * <td>int</td>
 * <td>0</td>
 * <td>The time (in ms) to wait for existing requests to complete before fully stopping the server.</td>
 * </tr>
 * </table>
 * 
...
public abstract class JettyServerHelper extends org.restlet.engine.adapter.HttpServerHelper {
	...
	private static class WrappedServer extends org.eclipse.jetty.server.Server {
		...
		public void handle(HttpConnection connection) throws IOException, ServletException {
			this.helper.handle(new JettyCall(this.helper.getHelped(), connection));
		}
	}
