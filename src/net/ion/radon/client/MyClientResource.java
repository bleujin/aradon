...
public class MyClientResource extends UniformResource {
	...
	public static <T> T create(Context context, Reference reference, Class<? extends T> resourceInterface) {
		MyClientResource clientResource = new MyClientResource(context, reference);
	 ...
	 */
	public MyClientResource(MyClientResource resource) {
	 ...
	 *            The target URI.
	 */
	public MyClientResource(Context context, java.net.URI uri) {
	 ...
	 *            The target URI.
	 */
	public MyClientResource(Context context, Method method, java.net.URI uri) {
	 ...
	 *            The target reference.
	 */
	public MyClientResource(Context context, Method method, Reference reference) {
	 ...
	 *            The target URI.
	 */
	public MyClientResource(Context context, Method method, String uri) {
		this(context, method, new Reference(uri));
	}
	 ...
	 *            The target reference.
	 */
	public MyClientResource(Context context, Reference reference) {
	 ...
	 */
	public MyClientResource(Context context, Request request, Response response) {
		if (context == null) {
	 ...
	 *            The target URI.
	 */
	public MyClientResource(Context context, String uri) {
		this(context, Method.GET, uri);
	}
	 ...
	 *            The target URI.
	 */
	public MyClientResource(java.net.URI uri) {
	 ...
	 *            The target URI.
	 */
	public MyClientResource(Method method, java.net.URI uri) {
	 ...
	 *            The target reference.
	 */
	public MyClientResource(Method method, Reference reference) {
	 ...
	 *            The target URI.
	 */
	public MyClientResource(Method method, String uri) {
		this(Context.getCurrent(), method, uri);
	}
	 ...
	 *            The target reference.
	 */
	public MyClientResource(Reference reference) {
	 ...
	 *            The handled response.
	 */
	public MyClientResource(Request request, Response response) {
	 ...
	 *            The target URI.
	 */
	public MyClientResource(String uri) {
		this(Context.getCurrent(), null, uri);
	}

	/**
	 * Creates a next Restlet is no one is set. By default, it creates a new {@link Client} based on the protocol of the resource's URI reference.
	 * 
	...
	/**
	 * Deletes the target resource and all its representations. If a success status is not returned, then a resource exception is thrown.
	 * 
	...
	/**
	 * Represents the resource using content negotiation to select the best variant based on the client preferences. Note that the client preferences will be automatically adjusted, but only for this request. If you want to change them once for all, you can use the {@link #getClientInfo()} method.<br>
	 * <br>
	...
	/**
	 * Represents the resource in the given object class. Note that the client preferences will be automatically adjusted, but only for this request. If you want to change them once for all, you can use the {@link #getClientInfo()} method.<br>
	 * <br>
	 * If a success status is not returned, then a resource exception is thrown.
	 * 
	 * @param <T>
	...
	/**
	 * Represents the resource using a given media type. Note that the client preferences will be automatically adjusted, but only for this request. If you want to change them once for all, you can use the {@link #getClientInfo()} method.<br>
	 * <br>
	 * If a success status is not returned, then a resource exception is thrown.
	 * 
	 * @param mediaType
	 ...
	 * 
	 * @param relativeRef
	 *            The URI reference of the child resource relatively to the current resource seen as the parent resource.
	 * @return The child resource.
	 * @throws ResourceException
	 */
	public MyClientResource getChild(Reference relativeRef) throws ResourceException {
		MyClientResource result = null;

		if ((relativeRef != null) && relativeRef.isRelative()) {
			result = new MyClientResource(this);
	...
	public <T> T getChild(Reference relativeRef, Class<? extends T> resourceInterface) throws ResourceException {
		T result = null;
		MyClientResource childResource = getChild(relativeRef);
	 ...
	 * 
	 * @param relativeUri
	 *            The URI of the child resource relatively to the current resource seen as the parent resource.
	 * @return The child resource.
	 * @throws ResourceException
	 */
	public MyClientResource getChild(String relativeUri) throws ResourceException {
	 ...
	 */
	public MyClientResource getParent() throws ResourceException {
		MyClientResource result = null;
	...
	public <T> T getParent(Class<? extends T> resourceInterface) throws ResourceException {
		...
		MyClientResource parentResource = getParent();
	...
	/**
	 * Returns the number of retry attempts before reporting an error. Default value is 2.
	 * 
	...
	/**
	 * Returns the delay in milliseconds between two retry attempts. Default value is 2 seconds.
	 * 
	...
	/**
	 * Handles an object entity. Automatically serializes the object using the {@link org.restlet.service.ConverterService}.
	 * 
	 * @param method
	 *            The request method to use.
	 * @param entity
	...
	protected <T> T handle(Method method, Object entity, Class<T> resultClass) throws ResourceException {
		...
		result = toObject(handle(method, (entity == null) ? null : toRepresentation(entity, null), clientInfo), resultClass);
	 ...
	 * @return The optional response entity.
	 */
	private Representation handle(Method method, Representation entity, ClientInfo clientInfo) {
	 ...
	 * @return The optional response entity.
	 */
	private Representation handle(Method method, Representation entity, MediaType mediaType) {
		return handle(method, entity, new ClientInfo(mediaType));
	}

	/**
	 * Handles the call by invoking the next handler. Then a new response is created and the {@link #handle(Request, Response)} method is invoked and the response set as the latest response with {@link #setResponse(Response)}.
	 * 
	 * @param request
	 ...
	 * @param references
	 *            The references that caused a redirection to prevent infinite loops.
	 * @param retryAttempt
	 *            The number of remaining attempts.
	 * @param next
	 *            The next handler handling the call.
	 */
	private void handle(Request request, Response response, List<Reference> references, int retryAttempt, Uniform next) {
		if (next != null) {
			// Actually handle the call
	...
	/**
	 * Represents the resource using content negotiation to select the best variant based on the client preferences. This method is identical to {@link #get()} but doesn't return the actual content of the representation, only its metadata.<br>
	 * <br>
	 * Note that the client preferences will be automatically adjusted, but only for this request. If you want to change them once for all, you can use the {@link #getClientInfo()} method.<br>
	 * <br>
	 * If a success status is not returned, then a resource exception is thrown.
	 * 
	 * @return The best representation.
	 * @throws ResourceException
	 * @see <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec9.html#sec9.4">HTTP HEAD method</a>
	 */
	...
	/**
	 * Represents the resource using a given media type. This method is identical to {@link #get(MediaType)} but doesn't return the actual content of the representation, only its metadata.<br>
	 * <br>
	 * Note that the client preferences will be automatically adjusted, but only for this request. If you want to change them once for all, you can use the {@link #getClientInfo()} method.<br>
	 * <br>
	 * If a success status is not returned, then a resource exception is thrown.
	...
	/**
	 * Indicates if idempotent requests should be retried on error. Default value is true.
	 * 
	...
	/**
	 * Describes the resource using content negotiation to select the best variant based on the client preferences. If a success status is not returned, then a resource exception is thrown.
	 * 
	 * @return The best description.
	 * @throws ResourceException
	 * @see <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec9.html#sec9.2">HTTP OPTIONS method</a>
	 */
	...
	/**
	 * Describes the resource using a given media type. If a success status is not returned, then a resource exception is thrown.
	 * 
	 * @param <T>
	 *            The expected type for the response entity.
	 * @param resultClass
	...
	/**
	 * Posts an object entity. Automatically serializes the object using the {@link org.restlet.service.ConverterService}.
	 * 
	 * @param entity
	 *            The object entity to post.
	...
	/**
	 * Posts a representation. If a success status is not returned, then a resource exception is thrown.
	 * 
	 * @param entity
	 *            The posted entity.
	 * @return The optional result entity.
	...
	/**
	 * Puts an object entity. Automatically serializes the object using the {@link org.restlet.service.ConverterService}.
	 * 
	 * @param entity
	...
	/**
	 * Creates or updates a resource with the given representation as new state to be stored. If a success status is not returned, then a resource exception is thrown.
	 * 
	 * @param entity
	 ...
	 * 
	 * In addition, this method will set the context of the next Restlet if it is null by passing a reference to its own context.
	 * 
	 * @param next
	 *            The next handler.
	 */
	...
	/**
	 * Sets the resource's reference. If the reference is relative, it will be resolved as an absolute reference. Also, the context's base reference will be reset. Finally, the reference will be normalized to ensure a consistent handling of the call.
	 * 
	 * @param reference
	...
	/**
	 * Sets the resource's reference using an URI string. Note that the URI can be either absolute or relative to the context's base reference.
	 * 
	 * @param uri
	 *            The resource URI.
	...
	/**
	 * Sets the delay in milliseconds between two retry attempts. The default value is two seconds.
	 * 
	 * @param retryDelay
	...
	public <T> T wrap(Class<? extends T> resourceInterface) {
		...
		final MyClientResource clientResource = this;
