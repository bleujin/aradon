...
public class SocketIOConnectionXHRBase implements SocketIOConnection {
	...
	public SocketIOConnectionXHRBase(SocketIOConnection.SocketIOConnectionListener listener, String host, short port, String transport, boolean isConnectionPersistent) {
