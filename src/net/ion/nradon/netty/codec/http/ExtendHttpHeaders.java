package net.ion.nradon.netty.codec.http;
 ...
 */
public class ExtendHttpHeaders {
	...
	/**
	 * Sets the value of the {@code "Connection"} header depending on the protocol version of the specified message. This method sets or removes the {@code "Connection"} header depending on what the default keep alive mode of the message's protocol version is, as specified by {@link HttpVersion#isKeepAliveDefault()}.
	 * <ul>
	 ...
	 * Returns the integer header value with the specified header name. If there are more than one header value for the specified header name, the first value is returned.
	 * 
	 * @return the header value or the {@code defaultValue} if there is no such header or the header value is not a number
	 */
	...
	/**
	 * Returns the length of the content. Please note that this value is not retrieved from {@link HttpMessage#getContent()} but from the {@code "Content-Length"} header, and thus they are independent from each other.
	 * 
	 * @return the content length or {@code 0} if this message does not have the {@code "Content-Length"} header
	 */
	 ...
	 * Returns the length of the content. Please note that this value is not retrieved from {@link HttpMessage#getContent()} but from the {@code "Content-Length"} header, and thus they are independent from each other.
	 * 
	 * @return the content length or {@code defaultValue} if this message does not have the {@code "Content-Length"} header
	 */
	...
	/**
	 * Returns the value of the {@code "Host"} header. If there is no such header, the {@code defaultValue} is returned.
	 */
	...
	/**
	 * Sets the {@code "Expect: 100-continue"} header to the specified message. If there is any existing {@code "Expect"} header, they are replaced with the new one.
	 */
