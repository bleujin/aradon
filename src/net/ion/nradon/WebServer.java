 ...
 * 		response.header(&quot;Content-Type&quot;, &quot;text/html&quot;).content(&quot;Hello World&quot;).end();
 * 	}
 * }
 * WebServer webServer = WebServers.createWebServer(8080).add(new HelloWorldHandler()).start();
 ...
 * 
 * <pre>
 * WebServer webServer = WebServers.createWebServer(8080).add(new StaticFileHandler(&quot;./wwwdata&quot;)).start();
 * </pre>
 * 
 * @author Joe Walnes
 * @see WebServers
...
public interface WebServer {
	 ...
	 * @see HttpHandler
	 * @see #add(HttpHandler)
	 * @see net.ion.nradon.handler.PathMatchHandler
	 */
	 ...
	 * @see HttpHandler
	 * @see #add(HttpHandler)
	 * @see net.ion.nradon.handler.HttpToWebSocketHandler
	 * @see net.ion.nradon.handler.PathMatchHandler
	 */
	 ...
	 * @see HttpHandler
	 * @see #add(HttpHandler)
	 * @see net.ion.nradon.handler.HttpToEventSourceHandler
	 * @see net.ion.nradon.handler.PathMatchHandler
	 */
	...
	/**
	 * Call after {@link #stop()} to wait until webserver has stopped its background threads and closed all socket connections. This method blocks.
	 */
	 ...
	 * <p/>
	 * Defaults to using {@link net.ion.nradon.handler.exceptions.PrintStackTraceExceptionHandler}. It is suggested that apps supply their own implementation (e.g. to log somewhere).
	 */
	 ...
	 * <p/>
	 * Defaults to using {@link net.ion.nradon.handler.exceptions.SilentExceptionHandler} as this is a common thing to happen on a network, and most systems should not care.
	 */
