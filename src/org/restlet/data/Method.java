...
public final class Method implements Comparable<Method> {
    ...
    public static final Method SEARCH = new Method(
            "SEARCH",
            "Identical to Search except that the server must not return a message body in the response",
            BASE_HTTP + "#undefined", true, true);

    public static final Method LIST = new Method(
            "LIST",
            "Identical to List except that the server must not return a message body in the response",
            BASE_HTTP + "#undefined", true, true);

    public static final Method EXECUTE = new Method(
            "EXECUTE",
            "Identical to List except that the server must not return a message body in the response",
            BASE_HTTP + "#undefined", true, true);
